  ...
  return (
    <div style={{ height:"100%", overflowY:"auto", padding:"0 20px 100px" }}>
      ...
      <p style={{ fontFamily:"Georgia,serif", fontSize:13, color:MIDGREY, lineHeight:1.6, margin:"0 0 24px" }}>
        Select the groups you belong to. Their prayer requests will appear in your Family Prayer Wall filter.
      </p>
      ...
      {GROUPS.map(group => {
        ...
        return (
          <div
            ...
            style={{ display:"flex", alignItems:"center", gap:14, background: inGroup ? "rgba(46,125,107,0.08)" : "rgba(255,255,255,0.7)", borderRadius:14, padding:"16px 18px", marginBottom:10, border:`1.5px solid ${inGroup ? TEAL : "rgba(46,125,107,0.15)"}`, cursor:"pointer" }}
          >
            ...
            {/* Checkbox */}
            <div style={{ width:26, height:26, borderRadius:13, border:`2px solid ${inGroup ? TEAL : LTGREY}`, background: inGroup ? TEAL : "transparent", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, opacity: busy ? 0.5 : 1 }}>
