  ...
  return (
    <div style={{ height:"100%", overflowY:"auto", padding:"0 24px 40px" }}>
      <div style={{ textAlign:"center", padding:"40px 0 28px" }}>
        ...
        <p style={{ fontFamily:"Georgia,serif", fontSize:13, color:MIDGREY, margin:0, fontStyle:"italic" }}>Join the Perfectly Flawed Families community</p>
      </div>
      ...
      <p style={{ textAlign:"center", fontFamily:"Georgia,serif", fontSize:13, color:MIDGREY, marginTop:24 }}>
        ...
        <span onClick={onSwitch} style={{ color:TEAL, fontWeight:600, cursor:"pointer" }}>Sign in</span>
      </p>
    </div>
  );
}
