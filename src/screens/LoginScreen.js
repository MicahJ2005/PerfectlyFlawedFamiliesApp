...
import { RootsIcon, EyeIcon, GoogleLogo } from "../components/icons";
  ...
  return (
    <div style={{ height:"100%", overflowY:"auto", padding:"0 24px 40px" }}>
      <div style={{ textAlign:"center", padding:"48px 0 32px" }}>
        <div style={{ display:"inline-flex", alignItems:"center", justifyContent:"center", width:80, height:80, background:"rgba(46,125,107,0.1)", borderRadius:"50%", marginBottom:18, border:"2px solid rgba(46,125,107,0.25)" }}>
          <RootsIcon size={44} />
        </div>
        <h1 style={{ fontFamily:"Georgia,serif", fontSize:26, fontWeight:700, color:CHARCOAL, margin:"0 0 4px" }}>Perfectly Flawed</h1>
        <p style={{ fontFamily:"Georgia,serif", fontSize:13, color:TEAL, margin:0, letterSpacing:"0.2em", fontWeight:600, textTransform:"uppercase" }}>Families</p>
      ...
      <div style={css.card}>
        ...
        <div style={{ textAlign:"right", marginBottom:18, marginTop:-8 }}>
          <span onClick={handleReset} style={{ fontFamily:"Georgia,serif", fontSize:12, color:TEAL, cursor:"pointer", fontWeight:600 }}>Forgot password?</span>
        </div>
      ...
      <p style={{ textAlign:"center", fontFamily:"Georgia,serif", fontSize:13, color:MIDGREY, marginTop:24 }}>
        ...
        <span onClick={onSwitch} style={{ color:TEAL, fontWeight:600, cursor:"pointer" }}>Sign up</span>
      </p>
    </div>
  );
}
